...
var getCategories = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, typeorm_1.getRepository(Categories_1.Categories).find()];
            case 1:
                categories = _a.sent();
...
var getCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, typeorm_1.getRepository(Categories_1.Categories).findOne(req.params.id)];
            case 1:
                result = _a.sent();
...
var createCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, typeorm_1.getRepository(Categories_1.Categories).create(req.body)];
            case 1:
                newCategory = _a.sent();
                return [4 /*yield*/, typeorm_1.getRepository(Categories_1.Categories).save(newCategory)];
            case 2:
                results = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                typeorm_1.getRepository(Categories_1.Categories).merge(category, req.body);
...
var deleteCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, typeorm_1.getRepository(Categories_1.Categories).delete(req.params.id)];
            case 1:
                result = _a.sent();
                return [2 /*return*/, res.json(result)];
        }
